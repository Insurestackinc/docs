...
<Tip>
  Use a strong, unique password for your Mulligan account. Consider using a password manager.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion icon="language" title="Language">
    Currently, Mulligan is available in English only. Additional languages may be added in future updates.
  </Accordion>
</AccordionGroup>
