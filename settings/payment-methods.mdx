...
Mulligan uses **Stripe** for secure payment processing. All payment data is handled by Stripe - Mulligan never stores your full card details.
...
<Note>
  All payment information is processed and stored by Stripe, not Mulligan. Your card details are encrypted and PCI-compliant.
</Note>
...
<AccordionGroup>
  ...
  <Accordion icon="circle-question" title="Are there any fees or markups?">
    No. You pay exactly what's listed in our pricing. Mulligan does not charge any additional processing fees.

    Standard Stripe fees are absorbed by Mulligan - you don't pay them.
  </Accordion>
