---
title: "Credit Types"
description: "Understanding the three types of credits in Mulligan"
---

## Overview

Mulligan has **three types of credits**, each with different rules for expiration, rollover, and priority.
...
You're on the Plus plan and have purchased 50 extra credits. Here's how Mulligan uses your credits:
...
<AccordionGroup>
  ...
  <Accordion icon="circle-question" title="How do I know which type of credit I'm using?">
    You don't need to track this manually. Mulligan automatically uses credits in priority order: free → plan → purchased. Check your Balance Display to see your total remaining credits.
  </Accordion>
</AccordionGroup>
